public class shewillbeloved {
    ...
    public static void singSong() {
        String[][] lyrics = {
                ...
                { "Out on your corner in the pouring rain", "80" },
                { "Look for the girl with the broken smile", "40" },
                { "Ask her if she wants to stay a while?", "60" },
                { "And she will be loved", "40" },
                { "And she will be lovedddddddddd", "100" }
        };
